...
// DMC: ini_set('display_errors', '0');
// DMC: ini_set('error_reporting', E_PARSE);
...
<p><?=$language->misc["copyright"]?> &copy; 2002<? date("Y") != "2002" ? print("-".date("Y")) : print(""); ?> <a class="legalText" href="http://www.kingdesign.net/">King Design</a>.<br>
<?=$language->misc["all_rights_reserved"]?> <a href="mobile.php?screen=about">About Tasks Jr.</a><br>
<?
include("version.inc");
