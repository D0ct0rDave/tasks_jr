...
if (isset($_REQUEST["install"]) && $_REQUEST["install"] == 1) {
	...
	if ($create != false) {
		...
		$insert = mysql_query("INSERT INTO ".$database->table_name." (ID, parent, title, notes, status, priority, URL_1, URL_2, URL_3, date_due, date_modified, date_entered, obsolete, container, type, user_date_1, user_date_2, user_text_1, user_text_2, user_int_1, user_int_2) VALUES (3, 2, 'Sub-Task with later due date', '', 0, 3, '', '', '', '".date("Y-m-d", time() + (3600 * 24 * 7))."', 20030101155022, 20021213093957, 0, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '', 0, 0)");
	
		$insert = mysql_query("INSERT INTO ".$database->table_name." (ID, parent, title, notes, status, priority, URL_1, URL_2, URL_3, date_due, date_modified, date_entered, obsolete, container, type, user_date_1, user_date_2, user_text_1, user_text_2, user_int_1, user_int_2) VALUES (4, 2, 'Sub-Task with due date', 'notes here if needed', 50, 3, '', '', '', '".date("Y-m-d", time() + (3600 * 24 * 2))."', 20030101155002, 20021213094036, 0, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '', 0, 0)");
